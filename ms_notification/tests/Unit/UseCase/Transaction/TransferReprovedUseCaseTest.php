...
class TransferReprovedUseCaseTest extends TestCase
{
    ...
    public function testExecuteSuccess()
    {
        ...
        $accountDb = ModelsAccount::find($transactionDb->payer_id);
        $this->assertEquals(80, $accountDb->balance);
        $transactionDb = ModelsTransaction::find($transactionDb->id);
        $this->assertEquals(TransactionStatus::ERROR->value, $transactionDb->transaction_status);
